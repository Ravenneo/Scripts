...
df = pd.read_csv(file_name, sep="\t", low_memory=False, names = (['ID', 'Source', 'Nucleotide Accession', 'Protein', 
                                                                 'Protein Name', 'Start', 'Stop', 'Strand', 'Organism',' Strain', 'Assembly']))
...
df.to_csv(file_name_output + ".tsv", "\t", index=False)
